...
**Purpose:** Portable skills records, earned reputation, and Open Badge credentials  
for Canada's skilled trades workforce.  
**Positioning:** Robin is not LinkedIn for trades. Reputation on Robin is earned, not given.  
A journeyperson with 850 points in panel installation got there because their peers found  
their answers credible — not because coworkers clicked a button.  
...
2. **Earn don't claim.** Expert status and reputation are earned through demonstrated community knowledge — never self-declared or socially gifted.
...
6. **Mirror standards, never define them.** Robin reflects ESDC National Occupational Standards (NOS) for skill taxonomy and gap analysis. Robin is not a certifier, a regulator, or a competency assessor. Any language suggesting Robin grades or certifies tradespeople must be reviewed by a human before shipping.
7. **Profiles are always public.** There is no private profile. Do not build privacy toggles for profiles. The 30-day grace period is an onboarding buffer, not a permanent option.
